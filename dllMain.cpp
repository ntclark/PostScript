...
#define OBJECT_NAME "InnoVisioNate.PStoPDF"
#define OBJECT_NAME_V "InnoVisioNate.PStoPDF.1"
#define OBJECT_VERSION "1.0"
#define OBJECT_CLSID CLSID_PostScript
#define OBJECT_LIBID LIBID_PostScript
...
extern "C" int GetCommonAppDataLocation(HWND hwnd,char *szFolderLocation) {
...
//   strcpy(szFolderLocation,strRet.pOleStr);
