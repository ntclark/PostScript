...
Take a look at sources in this repository that handle the PostScript operators. Currently there are two: [operatorsAtoL.cpp](./PostScript/operators/operators_AtoL.cpp), and [operatorsMtoZ.cpp](./PostScript/operators/operators_MtoZ.cpp).
