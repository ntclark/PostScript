...
#include "Renderer.h"
  ...
  Renderer::_IEnumerateConnections::_IEnumerateConnections(
            IUnknown* pHostObj,
            ULONG cConnections,
  ...
  STDMETHODIMP Renderer::_IEnumerateConnections::QueryInterface(REFIID riid,void **ppv) {
  *ppv = NULL;
  ...
  *ppv = (LPVOID)this;
  ...
  STDMETHODIMP_(ULONG) Renderer::_IEnumerateConnections::AddRef() {
  ...
  STDMETHODIMP_(ULONG) Renderer::_IEnumerateConnections::Release() {
  ...
  STDMETHODIMP Renderer::_IEnumerateConnections::Next(ULONG cReq,CONNECTDATA* paConnections,ULONG* pcEnumerated) {
...
//    if ( NULL != paConnections -> pUnk ) paConnections -> pUnk -> AddRef();
  ...
  STDMETHODIMP Renderer::_IEnumerateConnections::Skip(ULONG cSkip) {
  ...
  STDMETHODIMP Renderer::_IEnumerateConnections::Reset() {
  enumeratorIndex = 0;
  return S_OK;
  }
  ...
  STDMETHODIMP Renderer::_IEnumerateConnections::Clone(IEnumConnections** ppIEnum) {
